<form role="search" method="get" class="search-form styled-form text-center" action="<?php echo esc_url(home_url('/')); ?>">
	...
	<input type="search" value="<?php echo get_search_query(); ?>" name="s" class="search-field margin bottom-big" placeholder="<?php _e('Search', 'roots'); ?> <?php bloginfo('name'); ?>" required>
